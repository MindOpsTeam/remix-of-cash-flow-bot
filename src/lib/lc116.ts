// Lista de servicos anexa a LC 116/2003 (fonte: Planalto). Base do item da
// lista de servico (PlugNotas/Focus) e do codigo de tributacao nacional (NFS-e).
// Gerado automaticamente; descricoes podem refletir a consolidacao da lei.

export interface ItemLC116 { codigo: string; descricao: string }

export const LC116: ItemLC116[] = [
  ...
  { codigo: "3.04", descricao: "da lista anexa, considera-se ocorrido o fato gerador e devido o imposto em cada Município em cujo território haja extensão de ferrovia, rodovia, postes, cabos, dutos e condutos de qualquer natureza, objetos de locação, sublocação, arrendamento, direito de passagem ou permissão de uso, compartilhado ou não" },
  { codigo: "3.05", descricao: "da lista anexa; III – da execução da obra, no caso dos serviços descritos no subitem" },
  ...
  { codigo: "7.04", descricao: "da lista anexa; V – das edificações em geral, estradas, pontes, portos e congêneres, no caso dos serviços descritos no subitem" },
  { codigo: "7.05", descricao: "da lista anexa; VI – da execução da varrição, coleta, remoção, incineração, tratamento, reciclagem, separação e destinação final de lixo, rejeitos e outros resíduos quaisquer, no caso dos serviços descritos no subitem" },
  ...
  { codigo: "7.09", descricao: "da lista anexa; VII – da execução da limpeza, manutenção e conservação de vias e logradouros públicos, imóveis, chaminés, piscinas, parques, jardins e congêneres, no caso dos serviços descritos no subitem" },
  { codigo: "7.10", descricao: "da lista anexa; VIII – da execução da decoração e jardinagem, do corte e poda de árvores, no caso dos serviços descritos no subitem" },
  { codigo: "7.11", descricao: "da lista anexa; IX – do controle e tratamento do efluente de qualquer natureza e de agentes físicos, químicos e biológicos, no caso dos serviços descritos no subitem" },
  { codigo: "7.12", descricao: "da lista anexa; X –" },
  ...
  { codigo: "7.14", descricao: "(vetado)" },
  { codigo: "7.15", descricao: "(vetado)" },
  { codigo: "7.16", descricao: "Florestamento, reflorestamento, semeadura, adubação e congêneres" },
  { codigo: "7.17", descricao: "da lista anexa; XIV – da limpeza e dragagem, no caso dos serviços descritos no subitem" },
  { codigo: "7.18", descricao: "da lista anexa; XV – onde o bem estiver guardado ou estacionado, no caso dos serviços descritos no subitem" },
  { codigo: "7.19", descricao: "da lista anexa; III  da execução da obra, no caso dos serviços descritos nos subitens 7.02," },
  ...
  { codigo: "10.04", descricao: "e 15.09" },
  ...
  { codigo: "11.01", descricao: "da lista anexa; XVI – dos bens ou do domicílio das pessoas vigiados, segurados ou monitorados, no caso dos serviços descritos no subitem" },
  { codigo: "11.02", descricao: "da lista anexa; XVI - dos bens, dos semoventes ou do domicílio das pessoas vigiados, segurados ou monitorados, no caso dos serviços descritos no subitem" },
  { codigo: "11.03", descricao: "Escolta, inclusive de veículos e cargas" },
  { codigo: "11.04", descricao: "da lista anexa; XVIII – da execução dos serviços de diversão, lazer, entretenimento e congêneres, no caso dos serviços descritos nos subitens do item 12, exceto o 12.13, da lista anexa; XIX – do Município onde está sendo executado o transporte, no caso dos serviços descritos pelo subitem" },
  ...
  { codigo: "14.14", descricao: "da lista anexa" },
  { codigo: "15.01", descricao: "da lista de serviços anexa a esta Lei Complementar, prestados diretamente aos portadores de cartões de crédito ou débito e congêneres, o tomador é o primeiro titular do cartão" },
  ...
  { codigo: "16.01", descricao: "da lista anexa; XIX - do Município onde está sendo executado o transporte, no caso dos serviços descritos pelo item 16 da lista anexa" },
  ...
  { codigo: "17.05", descricao: "da lista anexa; XXI – da feira, exposição, congresso ou congênere a que se referir o planejamento, organização e administração, no caso dos serviços descritos pelo subitem" },
  ...
  { codigo: "17.07", descricao: "(vetado)" },
  { codigo: "17.08", descricao: "Franquia ( franchising )" },
  { codigo: "17.09", descricao: "Perícias, laudos, exames técnicos e análises técnicas" },
  { codigo: "17.10", descricao: "da lista anexa; XXII – do porto, aeroporto, ferroporto, terminal rodoviário, ferroviário ou metroviário, no caso dos serviços descritos pelo item 20 da lista anexa. XXIII - do domicílio do tomador dos serviços dos subitens 4.22," },
...
/** Codigo de tributacao nacional (cTribNac, 6 digitos) derivado do item LC 116.
 *  Ex.: "1.07" -> "010700". O desdobramento (2 ultimos digitos) fica "00" por
 *  padrao; ajuste manualmente quando o municipio exigir um desdobramento especifico. */
export function cTribNacDeLC116(item: string): string {
